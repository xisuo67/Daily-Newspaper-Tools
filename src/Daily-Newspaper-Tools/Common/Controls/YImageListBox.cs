...
/******************************************************************************
 *特别说明，由于原UIImageListBox功能不满足需求，特二开后调整
* *****************************************************************************/
using Daily_Newspaper_Tools.Common.Style;
using Sunny.UI;
using System;
...
namespace Daily_Newspaper_Tools.Common.Controls
{
    [DefaultEvent("ItemClick")]
    public sealed partial class YImageListBox : UIPanel, IToolTip
    {
        private readonly ImageListBox listbox = new ImageListBox();
        private readonly UIScrollBar bar = new UIScrollBar();

        public YImageListBox()
        {
